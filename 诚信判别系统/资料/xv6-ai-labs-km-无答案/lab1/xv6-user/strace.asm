...
main(int argc, char *argv[])
{
  ...
  if(argc < 3 /*|| (argv[1][0] < '0' || argv[1][0] > '9')*/){
   c:	4789                	li	a5,2
   e:	02a7c263          	blt	a5,a0,32 <main+0x32>
  12:	e626                	sd	s1,264(sp)
    fprintf(2, "usage: %s MASK COMMAND\n", argv[0]);
  14:	6190                	ld	a2,0(a1)
  16:	00001597          	auipc	a1,0x1
  1a:	8aa58593          	addi	a1,a1,-1878 # 8c0 <malloc+0x102>
  1e:	4509                	li	a0,2
  20:	00000097          	auipc	ra,0x0
  24:	6b8080e7          	jalr	1720(ra) # 6d8 <fprintf>
    exit(1);
  28:	4505                	li	a0,1
  2a:	00000097          	auipc	ra,0x0
  2e:	34c080e7          	jalr	844(ra) # 376 <exit>
  32:	e626                	sd	s1,264(sp)
  34:	84aa                	mv	s1,a0
  }
  ...
  3c:	22c080e7          	jalr	556(ra) # 264 <atoi>
  40:	00000097          	auipc	ra,0x0
  44:	3e6080e7          	jalr	998(ra) # 426 <trace>
  48:	04054e63          	bltz	a0,a4 <main+0xa4>
  4c:	01090793          	addi	a5,s2,16
  50:	ee040713          	addi	a4,s0,-288
  54:	ffd4869b          	addiw	a3,s1,-3
  58:	02069613          	slli	a2,a3,0x20
  5c:	01d65693          	srli	a3,a2,0x1d
  60:	96be                	add	a3,a3,a5
  62:	10090593          	addi	a1,s2,256
  ...
  68:	e310                	sd	a2,0(a4)
  for(i = 2; i < argc && i < MAXARG; i++){
  6a:	00d78663          	beq	a5,a3,76 <main+0x76>
  6e:	07a1                	addi	a5,a5,8
  70:	0721                	addi	a4,a4,8
  72:	feb79ae3          	bne	a5,a1,66 <main+0x66>
  }
  exec(nargv[0], nargv);  
  76:	ee040593          	addi	a1,s0,-288
  7a:	ee043503          	ld	a0,-288(s0)
  7e:	00000097          	auipc	ra,0x0
  82:	330080e7          	jalr	816(ra) # 3ae <exec>
  printf("strace: exec %s fail\n", nargv[0]);
  86:	ee043583          	ld	a1,-288(s0)
  8a:	00001517          	auipc	a0,0x1
  8e:	86650513          	addi	a0,a0,-1946 # 8f0 <malloc+0x132>
  92:	00000097          	auipc	ra,0x0
  96:	674080e7          	jalr	1652(ra) # 706 <printf>
  exit(0);
  9a:	4501                	li	a0,0
  9c:	00000097          	auipc	ra,0x0
  a0:	2da080e7          	jalr	730(ra) # 376 <exit>
    fprintf(2, "%s: strace failed\n", argv[0]);
  a4:	00093603          	ld	a2,0(s2)
  a8:	00001597          	auipc	a1,0x1
  ac:	83058593          	addi	a1,a1,-2000 # 8d8 <malloc+0x11a>
  b0:	4509                	li	a0,2
  b2:	00000097          	auipc	ra,0x0
  b6:	626080e7          	jalr	1574(ra) # 6d8 <fprintf>
    exit(1);
  ba:	4505                	li	a0,1
  bc:	00000097          	auipc	ra,0x0
  c0:	2ba080e7          	jalr	698(ra) # 376 <exit>
...
gets(char *buf, int max)
{
 ...
 1e0:	1b2080e7          	jalr	434(ra) # 38e <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 230:	18a080e7          	jalr	394(ra) # 3b6 <open>
  if(fd < 0)
 234:	02054663          	bltz	a0,260 <stat+0x42>
 238:	e426                	sd	s1,8(sp)
 23a:	84aa                	mv	s1,a0
    return -1;
  r = fstat(fd, st);
 ...
 242:	180080e7          	jalr	384(ra) # 3be <fstat>
 246:	892a                	mv	s2,a0
  close(fd);
 248:	8526                	mv	a0,s1
 24a:	00000097          	auipc	ra,0x0
 24e:	154080e7          	jalr	340(ra) # 39e <close>
  return r;
 252:	64a2                	ld	s1,8(sp)
}
 254:	854a                	mv	a0,s2
...
atoi(const char *s)
{
 ...
 27c:	fd07079b          	addiw	a5,a4,-48
 280:	0ff7f793          	zext.b	a5,a5
 284:	46a5                	li	a3,9
 286:	02f6ed63          	bltu	a3,a5,2c0 <atoi+0x5c>
  n = 0;
 28a:	4681                	li	a3,0
  while('0' <= *s && *s <= '9')
 28c:	4625                	li	a2,9
 ...
 290:	0026979b          	slliw	a5,a3,0x2
 294:	9fb5                	addw	a5,a5,a3
 296:	0017979b          	slliw	a5,a5,0x1
 29a:	9fb9                	addw	a5,a5,a4
 29c:	fd07869b          	addiw	a3,a5,-48
  while('0' <= *s && *s <= '9')
 2a0:	00054703          	lbu	a4,0(a0)
 2a4:	fd07079b          	addiw	a5,a4,-48
 2a8:	0ff7f793          	zext.b	a5,a5
 2ac:	fef671e3          	bgeu	a2,a5,28e <atoi+0x2a>
  return n * neg;
}
 2b0:	02d5853b          	mulw	a0,a1,a3
 2b4:	6422                	ld	s0,8(sp)
...
free(void *ap)
{
 ...
 74a:	23a7b783          	ld	a5,570(a5) # 980 <freep>
 ...
 772:	00e6ea63          	bltu	a3,a4,786 <free+0x4a>
{
 ...
 7b4:	1cf73823          	sd	a5,464(a4) # 980 <freep>
}
 7b8:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7de:	1a653503          	ld	a0,422(a0) # 980 <freep>
 ...
 80e:	17690913          	addi	s2,s2,374 # 980 <freep>
  if(p == (char*)-1)
 812:	5afd                	li	s5,-1
 ...
 822:	16a78793          	addi	a5,a5,362 # 988 <base>
 ...
 868:	b82080e7          	jalr	-1150(ra) # 3e6 <sbrk>
  if(p == (char*)-1)
 ...
 8a0:	0ea73223          	sd	a0,228(a4) # 980 <freep>
      return (void*)(p + 1);
