...
- 输入目录：D:\\操作系统实验评分机制\\学生操作系统实验数据爬取\\操作系统实验数据记录
- 处理学生数：12
- 成功学生数：11
- 跳过数量：0
- 失败或部分失败学生数：1
...
- D:\\操作系统实验评分机制\\学生操作系统实验数据爬取\\操作系统实验数据记录\\2406080104-方如轩-20260909-1237\\term\\20260909T120838-19233.out.gz \[完整重放/目录分类\] ValueError: 录像为空或缺少 script 头部换行
