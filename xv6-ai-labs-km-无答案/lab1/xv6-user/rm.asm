...
main(int argc, char *argv[])
{
  ...
  if(argc < 2){
   8:	4785                	li	a5,1
   a:	02a7d463          	bge	a5,a0,32 <main+0x32>
   e:	ec26                	sd	s1,24(sp)
  10:	e84a                	sd	s2,16(sp)
  12:	e44e                	sd	s3,8(sp)
  ...
  2c:	87098993          	addi	s3,s3,-1936 # 898 <malloc+0x11c>
  30:	a02d                	j	5a <main+0x5a>
  32:	ec26                	sd	s1,24(sp)
  34:	e84a                	sd	s2,16(sp)
  36:	e44e                	sd	s3,8(sp)
    fprintf(2, "Usage: rm files...\n");
  38:	00001597          	auipc	a1,0x1
  3c:	84858593          	addi	a1,a1,-1976 # 880 <malloc+0x104>
  40:	4509                	li	a0,2
  ...
  50:	2e8080e7          	jalr	744(ra) # 334 <exit>
  for(i = 1; i < argc; i++){
  54:	04a1                	addi	s1,s1,8
  56:	03248163          	beq	s1,s2,78 <main+0x78>
    if(remove(argv[i]) < 0){
  5a:	6088                	ld	a0,0(s1)
  5c:	00000097          	auipc	ra,0x0
  60:	380080e7          	jalr	896(ra) # 3dc <remove>
  64:	fe0558e3          	bgez	a0,54 <main+0x54>
      fprintf(2, "rm: %s failed to delete\n", argv[i]);
  68:	6090                	ld	a2,0(s1)
  6a:	85ce                	mv	a1,s3
  6c:	4509                	li	a0,2
  6e:	00000097          	auipc	ra,0x0
  72:	628080e7          	jalr	1576(ra) # 696 <fprintf>
  76:	bff9                	j	54 <main+0x54>
    }
  }
  ...
  7e:	2ba080e7          	jalr	698(ra) # 334 <exit>
...
strcat(char *s, const char *t)
{
  ...
  a8:	c385                	beqz	a5,c8 <strcat+0x2a>
  aa:	87aa                	mv	a5,a0
    s++;
  ac:	0785                	addi	a5,a5,1
  while(*s)
  ae:	0007c703          	lbu	a4,0(a5)
  b2:	ff6d                	bnez	a4,ac <strcat+0xe>
  while((*s++ = *t++))
  b4:	0585                	addi	a1,a1,1
  b6:	0785                	addi	a5,a5,1
  b8:	fff5c703          	lbu	a4,-1(a1)
  bc:	fee78fa3          	sb	a4,-1(a5)
  c0:	fb75                	bnez	a4,b4 <strcat+0x16>
    ;
  return os;
}
  c2:	6422                	ld	s0,8(sp)
...
gets(char *buf, int max)
{
 ...
 19e:	1b2080e7          	jalr	434(ra) # 34c <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1ee:	18a080e7          	jalr	394(ra) # 374 <open>
  if(fd < 0)
 1f2:	02054663          	bltz	a0,21e <stat+0x42>
 1f6:	e426                	sd	s1,8(sp)
 1f8:	84aa                	mv	s1,a0
    return -1;
  r = fstat(fd, st);
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 440:	4dc50513          	addi	a0,a0,1244 # 918 <digits>
 444:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 546:	37e70713          	addi	a4,a4,894 # 8c0 <malloc+0x144>
 ...
 5d2:	34ab8b93          	addi	s7,s7,842 # 918 <digits>
 ...
 628:	29490913          	addi	s2,s2,660 # 8b8 <malloc+0x13c>
        while(*s != 0){
 ...
 730:	00e6ea63          	bltu	a3,a4,744 <free+0x4a>
{
 ...
 772:	1cf73123          	sd	a5,450(a4) # 930 <freep>
}
 776:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 79c:	19853503          	ld	a0,408(a0) # 930 <freep>
 ...
 7cc:	16890913          	addi	s2,s2,360 # 930 <freep>
  if(p == (char*)-1)
 7d0:	5afd                	li	s5,-1
 ...
 7e0:	15c78793          	addi	a5,a5,348 # 938 <base>
 7e4:	00000717          	auipc	a4,0x0
 7e8:	14f73623          	sd	a5,332(a4) # 930 <freep>
 7ec:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 826:	b82080e7          	jalr	-1150(ra) # 3a4 <sbrk>
  if(p == (char*)-1)
 ...
 85e:	0ca73b23          	sd	a0,214(a4) # 930 <freep>
      return (void*)(p + 1);
